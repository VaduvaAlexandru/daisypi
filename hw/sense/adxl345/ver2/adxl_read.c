...
*
*  \note		Significant code ideas from gpxlogger.c\n
*				 - part of the gpsd project.
*
*  \author		Arvind Govindaraj\n
*				arvind.govindaraj@gmail.com
*
...
static FILE *logfile;
int i, temp, j = 0; //loop counters for looging
int16_t ax[ADXL_NoSamples], 
		ay[ADXL_NoSamples], 
		az[ADXL_NoSamples];
